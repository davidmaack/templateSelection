...
$GLOBALS['TL_LANG']['tl_theme']['ts_client_browser_version'] = array('Version', 'Please enter the matching browser verion.');
...
$GLOBALS['TL_LANG']['tl_theme']['ts_client_is_invert'] = array('Invert', 'Invert this filter rule.');
